# -*- coding: utf-8 -*-
"""
Created on Thu May 19 14:58:27 2016

@author: Kostas
"""

##cd "C:\Storage\Kostas\Research\WinPython\2016\YK1_M1classOriginal"
...
evaluateModels <- function(fname,m) {
  ...
  return(as.matrix(cbind(res0,res1,res2,res3,res4,res5)))
}
''')


r_evaluateModels = robjects.globalenv['evaluateModels']
print(r_evaluateModels.r_repr())
